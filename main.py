...
OWNER_ID = 7009468802 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [7009468802,5840594311,7856557198]
...
keyboard = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("🇮🇳ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ🇮🇳" ,url=f"https://t.me/rgtiger") ],
                    [
...
async def help_command(client: Client, msg: Message):
    help_text = (
        "`/start` - Start the bot⚡\n\n"
        "`/rgtiger` - Download and upload files (sudo)🎬\n\n"
...
@bot.on_message(filters.command(["rgtiger"]))
async def upload(bot: Client, m: Message):
    ...
    credit = "️[Rgtiger](https://t.me/RgTiger)"
    if raw_text3 == '1':
        CR = '[RgTiger](https://t.me/RgTiger)'
    elif raw_text3:
        try:
